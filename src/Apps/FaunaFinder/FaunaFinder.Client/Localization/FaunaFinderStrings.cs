...
public static class FaunaFinderStrings
{
    ...
    private static readonly Dictionary<string, string> En = new(StringComparer.Ordinal)
    {
        ...
        ["Rail_Card_Coordinates"] = "Coordinates",
        ["Rail_Card_Coordinates_Lede"] = "A point and radius, or a shape file",
        ["Coordinates_PageTitle"] = "Coordinates",
        ["Coordinates_Title"] = "Search by coordinates",
        ["Coordinates_Lede"] = "Enter a point and a radius, or upload a shape, and the map opens on the species found there.",
        ["Rail_Coordinates_Latitude"] = "Latitude",
        ["Rail_Coordinates_Longitude"] = "Longitude",
        ["Rail_Coordinates_Radius"] = "Radius (km)",
        ["Rail_Coordinates_Show"] = "Show on map",
        ["Rail_Coordinates_Invalid"] = "Latitude runs from -90 to 90 and longitude from -180 to 180.",
        ["Rail_Or"] = "or",
        ["Rail_Shape_Upload"] = "Upload a shape file",
        ["Rail_Shape_Reading"] = "Reading…",
        ["Rail_Shape_Formats"] = "GeoJSON, KML, or a zipped Shapefile, up to 10 MB.",
        ["Rail_Shape_Error_TooLarge"] = "Files must be 10 MB or less.",
        ["Rail_Shape_Error_Unreadable"] = "Couldn't read {0}.",
        ["Rail_Shape_Error_NoPolygon"] = "No polygon found in {0}.",
        ["Rail_Shape_Error_NotWgs84"] = "The shapefile must use WGS 84 latitude and longitude.",
        ...
        ["Map_Coordinates_Title"] = "Coordinates",
        ["Map_Coordinates_Eyebrow"] = "Within {0} km of {1}, {2}",
        ["Map_Shape_Title"] = "Shape file",
        ...
        ["Account_PageTitle"] = "Account",
        ["Account_Eyebrow"] = "Your account",
        ["Account_Title"] = "Profile &",
        ["Account_Title_Em"] = "sightings",
        ["Account_Lede"] = "Report what you see in the field, follow your reports through review, and sign out when you are done.",
        ["Account_MemberSince"] = "Member since",
        ["Account_Organization"] = "Organization",
        ["Account_Role_Member"] = "Member",
        ["Account_Role_Reviewer"] = "Reviewer",
        ["Account_Link_Mine_Desc"] = "Report what you saw and follow every report through review.",
        ["Account_Link_Review_Desc"] = "Approve or deny reports waiting on a decision.",
        ["Account_SignOut_Title"] = "Sign out of FaunaFinder",
        ["Account_SignOut_Body"] = "You will be returned to the map. Your reports stay where they are.",
        ["Account_Welcome_Title"] = "Welcome to FaunaFinder",
        ["Account_Welcome_Body"] = "Sign in to report sightings and follow your reports through review.",
        ["Account_Recent_Title"] = "Recent sightings",
        ["Account_Recent_Lede"] = "Your latest reports and where each one stands.",
        ["Account_Recent_SeeAll"] = "See all",
    ...
    private static readonly Dictionary<string, string> Es = new(StringComparer.Ordinal)
    {
        ...
        ["Rail_Heading"] = "Herramientas del mapa",
        ["Rail_Tab_Municipios"] = "Municipios",
        ["Rail_Tab_Taxa"] = "Taxones",
        ["Rail_Empty"] = "Todavía no hay registros.",
        ["Rail_Collapse"] = "Cerrar la barra lateral",
        ["Rail_Expand"] = "Abrir la barra lateral",
        ...
        ["Rail_Card_Coordinates"] = "Coordenadas",
        ["Rail_Card_Coordinates_Lede"] = "Un punto y radio, o un archivo de forma",
        ["Coordinates_PageTitle"] = "Coordenadas",
        ["Coordinates_Title"] = "Buscar por coordenadas",
        ["Coordinates_Lede"] = "Escribe un punto y un radio, o sube una forma, y el mapa se abre con las especies que hay allí.",
        ["Rail_Coordinates_Latitude"] = "Latitud",
        ["Rail_Coordinates_Longitude"] = "Longitud",
        ["Rail_Coordinates_Radius"] = "Radio (km)",
        ["Rail_Coordinates_Show"] = "Ver en el mapa",
        ["Rail_Coordinates_Invalid"] = "La latitud va de -90 a 90 y la longitud de -180 a 180.",
        ["Rail_Or"] = "o",
        ["Rail_Shape_Upload"] = "Subir un archivo de forma",
        ["Rail_Shape_Reading"] = "Leyendo…",
        ["Rail_Shape_Formats"] = "GeoJSON, KML o un Shapefile comprimido, hasta 10 MB.",
        ["Rail_Shape_Error_TooLarge"] = "El archivo debe pesar 10 MB o menos.",
        ["Rail_Shape_Error_Unreadable"] = "No se pudo leer {0}.",
        ["Rail_Shape_Error_NoPolygon"] = "No se encontró ningún polígono en {0}.",
        ["Rail_Shape_Error_NotWgs84"] = "El shapefile debe usar latitud y longitud WGS 84.",
        ...
        ["Map_Coordinates_Title"] = "Coordenadas",
        ["Map_Coordinates_Eyebrow"] = "En un radio de {0} km de {1}, {2}",
        ["Map_Shape_Title"] = "Archivo de forma",
        ...
        ["Account_PageTitle"] = "Cuenta",
        ["Account_Eyebrow"] = "Tu cuenta",
        ["Account_Title"] = "Perfil y",
        ["Account_Title_Em"] = "avistamientos",
        ["Account_Lede"] = "Reporta lo que ves en el campo, sigue tus reportes durante la revisión y cierra sesión cuando termines.",
        ["Account_MemberSince"] = "Miembro desde",
        ["Account_Organization"] = "Organización",
        ["Account_Role_Member"] = "Miembro",
        ["Account_Role_Reviewer"] = "Revisor",
        ["Account_Link_Mine_Desc"] = "Reporta lo que viste y sigue cada reporte durante la revisión.",
        ["Account_Link_Review_Desc"] = "Aprueba o rechaza los reportes que esperan una decisión.",
        ["Account_SignOut_Title"] = "Cerrar sesión en FaunaFinder",
        ["Account_SignOut_Body"] = "Volverás al mapa. Tus reportes se quedan donde están.",
        ["Account_Welcome_Title"] = "Bienvenido a FaunaFinder",
        ["Account_Welcome_Body"] = "Inicia sesión para reportar avistamientos y seguir tus reportes durante la revisión.",
        ["Account_Recent_Title"] = "Avistamientos recientes",
        ["Account_Recent_Lede"] = "Tus últimos reportes y el estado de cada uno.",
        ["Account_Recent_SeeAll"] = "Ver todos",
