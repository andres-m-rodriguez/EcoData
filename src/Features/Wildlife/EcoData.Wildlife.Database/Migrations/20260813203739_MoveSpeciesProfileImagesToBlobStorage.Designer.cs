...
namespace EcoData.Wildlife.Database.Migrations
{
    ...
    [Migration("20260813203739_MoveSpeciesProfileImagesToBlobStorage")]
    partial class MoveSpeciesProfileImagesToBlobStorage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EcoData.Wildlife.Database.Models.Species", b =>
                {
                    ...
                    b.Property<string>("ProfileImageBlobName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("profile_image_blob_name");
