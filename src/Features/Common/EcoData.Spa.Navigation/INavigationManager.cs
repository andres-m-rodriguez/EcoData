...
/// <see cref="Events.NavigationChanged"/> rather than a C# event, so subscribers
/// get automatic teardown and a marshalled re-render from <c>[Event]</c> instead
/// of hand-wiring <c>+=</c>/<c>-=</c>.</para>
/// </summary>
