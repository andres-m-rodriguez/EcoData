...
| Reactivity | Tempest.Blazor: `[Reactive]`/`[Command]`/`[Event]`, one re-render funnel | 5 mechanisms: legacy `Fetch<T>` (pre-Tempest reactivity package), grid cache, 2 event singletons, cascading locale, shadow fields |
